        ...
        <div class=" mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
              ...
              <div class="mt-4 lg:mt-0 lg:row-span-3">
                ...
                <div class="mt-6">
                  ...
                  <a href="#" class="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">0 reviews</a>
                </div>
                </div>
                <div class="mt-10">
                    <div class="mt-1">
                        ...
                        <input id="inputValue" type="number"  class="inline shadow-sm w-[50px] focus:ring-indigo-500 focus:border-indigo-500 mt-1 py-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="">
                    </div>
