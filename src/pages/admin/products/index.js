                                    ...
                                    <tbody>
                                        ${data.map((product, index) => /* html */`
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <img src="${product.img}" class="w-28 h-28" />
                                                </td>
                                                <td class="text-center">${product.price}</td>
                                                <td class="text-center">${product.quantily}</td>
                                                <td class="text-right ">
                                                    ...
                                                    <a href="/admin/products/edit/${product.id}">
                                                        <button data-id="${product.id}" class="bg-indigo-900 text-white p-3 rounded  hover:text-white-900">Edit</button>
                                                    </a>
